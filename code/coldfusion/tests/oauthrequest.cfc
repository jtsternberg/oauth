...
<cfcomponent 
	...
	<cffunction name="testsplitHeader" returntype="void" access="public" output="false">		
		<cfreturn assertTrue(true)><!--- splitHeader is a private function --->		
	</cffunction>
	...
	<cffunction name="testgenerateTimestamp" returntype="void" access="public" output="false">				
		<cfset assertTrue(true)><!--- generateTimeStamp is private --->		
	</cffunction>
	...
	<cffunction name="testbuildSignature" returntype="void" access="public" output="false">
		...
		<cfset sTemp = "RTM0MEY0ODVFM0M4MUFFNEYzNDdENDJGNUQ1QTA0ODcyRTc4RTUyNw==">
		<cfset assertEqualsString(sTemp, sResult)>
	</cffunction>
	...
	<cffunction name="testsignRequest" returntype="void" access="public" output="false">		
		...
		<cfset oTempSig = CreateObject("component", "oauth.oauthsignaturemethod_hmac_sha1")>
		<cfset sTemp = "QjBGQzREMkI4NjM2NEU2RDNCNDE2RERDOTM2REQ4N0Y3QjZEQUM1MA==">
		<cfset variables.oRequest.signRequest(oTempSig, variables.oConsumer, variables.oToken) >
		<cfset assertEqualsString(sTemp, variables.oRequest.getParameter("oauth_signature"))>
	</cffunction>
